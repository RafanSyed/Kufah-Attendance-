...
StudentModel.belongsToMany(ClassModel, { through: StudentClassModel, foreignKey: "student_id" });
ClassModel.belongsToMany(StudentModel, { through: StudentClassModel, foreignKey: "class_id" });
